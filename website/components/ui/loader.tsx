  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn("relative shrink-0", config.container)}
      ...
      {(Boolean(title) || Boolean(subtitle)) && (
        ...
        >
          {title && (
            <motion.h1
              animate={{ opacity: 1, y: 0 }}
              className={cn(config.titleClass, "font-medium text-black/90 leading-[1.15] tracking-[-0.02em] antialiased dark:text-white/90")}
              initial={{ opacity: 0, y: 12 }}
          ...
          {subtitle && (
            <motion.p
              animate={{ opacity: 1, y: 0 }}
              className={cn(config.subtitleClass, "font-normal text-black/60 leading-[1.45] tracking-[-0.01em] antialiased dark:text-white/60")}
