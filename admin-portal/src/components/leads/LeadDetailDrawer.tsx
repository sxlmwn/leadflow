  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex justify-end overflow-hidden">
        ...
        {/* Morphing Slide-over Drawer Panel */}
        <motion.div
          ...
          className="relative z-10 w-full max-w-2xl bg-card h-full shadow-2xl border-l border-border flex flex-col justify-between overflow-y-auto"
        >
          {/* Drawer Header */}
